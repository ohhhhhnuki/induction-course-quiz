...
public interface IssueRepository {
    ...
    void insertRanking(String name, int score, String category);

    @Insert("insert into inquiry (title, summary) values (#{title}, #{summary})")
    void insertInquiry(String title, String summary);
